...
function scene:create( event )
	...
	object[1] = display.newImageRect("image/mouse.png", 220, 220)
 	...
 	object[3] = display.newText("그때 고양이가 나타나", display.contentWidth*0.5, display.contentHeight - 400, "Font/오뮤_다예쁨체", 90)
 	object[3]:setFillColor(0)
 	object[4] = display.newText("키보드를 누르다", display.contentWidth*0.5, display.contentHeight - 300, "Font/오뮤_다예쁨체", 90)
 	object[4]:setFillColor(0)
 	object[5] = display.newText("어떤 게임이 시작된다.", display.contentWidth*0.5, display.contentHeight - 200, "Font/오뮤_다예쁨체", 90)
	...
	local function tapEventListener( event )
 		print("클릭했습니다!")
		composer.gotoScene( "opening3_3" , options)
 	end
...
function scene:hide( event )
	...
	if event.phase == "will" then
		...
		audio.stop(bgmChannel1)
		audio.stop(sleepSound)
		audio.play(touch)
		composer.removeScene('opening3_2')

...
function scene:create( event )
	...
	object[2] = display.newImage("image/catTalk.png", display.contentCenterX, display.contentCenterY + 510)
 	object[3] = display.newText("나랑 같이\n너에게 맞는 게임을\n찾아보자.", display.contentWidth*0.5, display.contentCenterY - 150, "Font/오뮤_다예쁨체", 90)
...
function scene:hide( event )
	...
	if event.phase == "will" then
		...
		audio.play(touch)
		composer.removeScene('opening5_7')

...
function scene:create( event )
	bgmChannel2 = audio.play(bgm2, {loops = -1})
	...
	local object = {}
 	...
 	object[3] = display.newText("여긴 어디지..?", display.contentWidth*0.5, display.contentHeight*0.22, "Font/오뮤_다예쁨체", 90)
...
function scene:hide( event )
	...
	if event.phase == "will" then
		...
		audio.play(touch)
		composer.removeScene('opening4_1')

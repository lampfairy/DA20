...
function scene:create( event )
	...
	local question = display.newText("무언가 과제가 주어지는 것을 좋아해?", display.contentCenterX, 330, "font/오뮤_다예쁨체")
	question.size = 65
	...
	local text = {}
	text[1] = display.newText("응 매일 과제가 주어지고\n해내는 것에 성취를 느껴",display.contentWidth * 0.43, display.contentHeight * 0.58, "font/오뮤_다예쁨체")
	text[1]:setTextColor(0)
	text[1].size = 60

	text[2] = display.newText("아니 과제는 싫어.\n내가 하고 싶은 걸 자유롭게 하고 싶어",display.contentWidth * 0.57, display.contentHeight * 0.75, "font/오뮤_다예쁨체")
	text[2]:setTextColor(0)
	text[2].size = 60

	text[3] = display.newText("8 / 9", display.contentWidth * 0.5, display.contentHeight * 0.05, "font/오뮤_다예쁨체")

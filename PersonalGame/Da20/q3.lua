...
function scene:create( event )
	...
	local question = display.newText("너는 게임할 때 소통하는게 좋아?", display.contentCenterX,  330, "font/오뮤_다예쁨체")
	question.size = 75
	...
	local text = {}
	text[1] = display.newText("응 나는 꼭 소통하는 편이야.",display.contentWidth * 0.43, display.contentHeight * 0.58, "font/오뮤_다예쁨체")
	text[1]:setTextColor(0)
	text[1].size = 60

	text[2] = display.newText("나는 필요한 말만 채팅하는 편이야",display.contentWidth * 0.57, display.contentHeight * 0.75, "font/오뮤_다예쁨체")
	text[2]:setTextColor(0)
	text[2].size = 60

	text[3] = display.newText("3 / 9", display.contentWidth * 0.5, display.contentHeight * 0.05, "font/오뮤_다예쁨체")

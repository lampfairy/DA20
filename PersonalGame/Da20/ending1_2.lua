...
function scene:create( event )
	...
	object[2] = display.newImage("image/catTalk.png", display.contentCenterX, display.contentCenterY + 510)
 	object[3] = display.newText(" 사실 출구는\n하나만 있는게 아니야.", display.contentWidth*0.5, display.contentCenterY - 150, "Font/오뮤_다예쁨체", 90)
...
function scene:hide( event )
	...
	if event.phase == "will" then
		...
		audio.play(touch)
		composer.removeScene('ending1_2')

...
function scene:create( event )
	...
	local object = {}
 	...
 	object[3] = display.newText("하.....", display.contentWidth*0.5, display.contentHeight*0.19, "Font/오뮤_다예쁨체", 90)
 	object[3]:setFillColor(0)
 	object[4] = display.newText("오늘도 너무 힘든 하루였다.", display.contentWidth*0.5, display.contentHeight*0.23, "Font/오뮤_다예쁨체", 90)

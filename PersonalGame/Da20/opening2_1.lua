...
function scene:create( event )
	...
	object[1] = display.newImageRect("image/mouse.png", 220, 220)
 	...
 	object[3] = display.newText("할 게임이 없네… ", display.contentWidth*0.5, display.contentHeight*0.22, "Font/오뮤_다예쁨체", 90)
...
function scene:hide( event )
	...
	if event.phase == "will" then
		...
		audio.play(touch)
		composer.removeScene('opening2_1')

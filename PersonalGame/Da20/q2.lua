...
function scene:create( event )
	...
	local question = display.newText("PC방은 주로 친구들이랑 가는 편이야?", display.contentCenterX, 330, "font/오뮤_다예쁨체")
	question.size = 70
	...
	local text = {}
	text[1] = display.newText("친구들이랑 함께 가서,".."\n".."같이 게임 하는 것이 좋아.",display.contentWidth * 0.43, display.contentHeight * 0.58, "font/오뮤_다예쁨체")
	text[1]:setTextColor(0)
	text[1].size = 60

	text[2] = display.newText("혼자서 조용히 게임하는 것이 편해.",display.contentWidth * 0.57, display.contentHeight * 0.75, "font/오뮤_다예쁨체")
	text[2]:setTextColor(0)
	text[2].size = 60

	text[3] = display.newText("2 / 9", display.contentWidth * 0.5, display.contentHeight * 0.05, "font/오뮤_다예쁨체")

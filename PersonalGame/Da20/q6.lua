...
function scene:create( event )
	...
	local question = display.newText("너는 어떤 것에서 행복을 느껴?", display.contentCenterX, 330, "font/오뮤_다예쁨체")
	question.size = 75
	...
	local text = {}
	text[1] = display.newText("게임에서 이겼을 때!",display.contentWidth * 0.43, display.contentHeight * 0.58, "font/오뮤_다예쁨체")
	text[1]:setTextColor(0)
	text[1].size = 60

	text[2] = display.newText("물건을 수집할 때!",display.contentWidth * 0.57, display.contentHeight * 0.75, "font/오뮤_다예쁨체")
	text[2]:setTextColor(0)
	text[2].size = 60

	text[3] = display.newText("6 / 9", display.contentWidth * 0.5, display.contentHeight * 0.05, "font/오뮤_다예쁨체")

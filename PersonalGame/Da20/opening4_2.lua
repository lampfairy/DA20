...
function scene:create( event )
	...
	object[2] = display.newImage("image/naration.png", display.contentCenterX, 1000)
 	object[3] = display.newText("눈 떠보니 여기는 숲 속", display.contentWidth*0.5, display.contentHeight - 300, "Font/오뮤_다예쁨체", 90)
...
function scene:hide( event )
	...
	if event.phase == "will" then
		...
		audio.play(touch)
		composer.removeScene('opening4_2')

...
function scene:create( event )
	...
	object[2] = display.newImage("image/catTalk.png", display.contentCenterX, display.contentCenterY + 510)
 	object[3] = display.newText("어떤 선택을 하더라도,\n그 선택에 대한\n다양한 출구가 기다리고 있어!", display.contentWidth*0.5, display.contentCenterY - 150, "Font/오뮤_다예쁨체", 90)
...
function scene:hide( event )
	...
	if event.phase == "will" then
		...
		audio.play(touch)
		composer.removeScene('ending1_3')

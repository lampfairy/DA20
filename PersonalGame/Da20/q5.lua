...
function scene:create( event )
	...
	local question = display.newText("어떤 사람이랑 게임하고 싶어?", display.contentCenterX, 330, "font/오뮤_다예쁨체")
	question.size = 75
	...
	local text = {}
	text[1] = display.newText("잘 모르는 사람이어도\n잘 하는 사람이랑 하고싶어",display.contentWidth * 0.43, display.contentHeight * 0.58, "font/오뮤_다예쁨체")
	text[1]:setTextColor(0)
	text[1].size = 60

	text[2] = display.newText("못하더라도 친한 사람이랑 하고싶어",display.contentWidth * 0.57, display.contentHeight * 0.75, "font/오뮤_다예쁨체")
	text[2]:setTextColor(0)
	text[2].size = 60

	text[3] = display.newText("5 / 9", display.contentWidth * 0.5, display.contentHeight * 0.05, "font/오뮤_다예쁨체")

...
function scene:create( event )
	...
	object[1] = display.newImageRect("image/mouse.png", 220, 220)
 	...
 	object[1]:setFillColor(0.6, 0.6, 0.6)
 	object[2] = display.newImage("image/personTalk.png", display.contentCenterX, -200)
 	object[3] = display.newText("z", display.contentWidth*0.5, display.contentHeight*0.22, "Font/오뮤_다예쁨체", 90)

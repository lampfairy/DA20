...
function scene:create( event )
	...
	local question = display.newText("매일매일 게임하는거 어때?", display.contentCenterX, 330, "font/오뮤_다예쁨체")
	question.size = 75
	...
	local text = {}
	text[1] = display.newText("귀찮고 스트레스 받는 일이야..",display.contentWidth * 0.43, display.contentHeight * 0.58, "font/오뮤_다예쁨체")
	text[1]:setTextColor(0)
	text[1].size = 60

	text[2] = display.newText("심심하지도 않고 오히려 좋은걸??",display.contentWidth * 0.57, display.contentHeight * 0.75, "font/오뮤_다예쁨체")
	text[2]:setTextColor(0)
	text[2].size = 60

	text[3] = display.newText("9 / 9", display.contentWidth * 0.5, display.contentHeight * 0.05, "font/오뮤_다예쁨체")
